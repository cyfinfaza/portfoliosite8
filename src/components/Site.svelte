...
<style lang="scss">
	...
	.site {
		...
		animation: inFromBottom 0.5s cubic-bezier(0, 0.61, 0.25, 1) backwards;
		&:hover {
			.iconLink {
				opacity: 1;
				transform: scale(1);
	...
	.siteDescription {
		...
		bottom: 0;
		left: 0;
		background: linear-gradient(to bottom, #0000 0%, #000c 80%);
		> * {
			margin: 0;
		}
	}
